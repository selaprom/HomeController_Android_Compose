...
@Composable
fun ItemGrid(
    iconleft: Int,iconright: Int,label:String,info:String,device:String
){
    var isCheck by remember { mutableStateOf<Boolean>(false) }
    Box(
        modifier = Modifier
            .height(235.dp)
            .background(color = MaterialTheme.colorScheme.onSecondaryContainer, shape = RoundedCornerShape(15.dp))
